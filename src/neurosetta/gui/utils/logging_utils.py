...
class QTextEditLogger(logging.Handler):
    ...
    def __init__(self, text_edit: QTextEdit):
        ...
        ----------
        text_edit : QTextEdit
            QTextEdit widget to display log messages.
        """
        super().__init__()
...
def setup_logging(text_edit: QTextEdit = None) -> None:
    ...
    Parameters
    ----------
    text_edit : QTextEdit, optional
        Optional QTextEdit widget for GUI logging. If provided, log messages
        will be displayed in the widget. By default None.
    """
    # Get root logger
