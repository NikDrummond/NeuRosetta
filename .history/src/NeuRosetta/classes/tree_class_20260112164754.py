...
class Tree_graph(_Tree):
    ...
    def leaf_indices(self) -> ndarray:
        return get_leaves(self)
    
    def branch_indices(self) -> ndarray:
        return get_branches(self)
    
    def core_indices(self, include_root:bool = True) -> ndarray:
        return get_core_inds(self, include_root)
...
Tree_graph.root_index.__doc__ = get_root.__doc__
Tree_graph.leaf_indices.__doc__ = get_leaves.__doc__
Tree_graph.branch_indices.__doc__ = get_branches.__doc__
Tree_graph.core_indices.__doc__ = get_core_inds.__doc__
