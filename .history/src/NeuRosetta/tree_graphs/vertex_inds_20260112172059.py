...
def get_edges(tree:_Tree, root: int|None = None, subset: str|None = None) -> ndarray:
    ...
    root : int | None, optional
        If provided, will return all edges downstream of the given root in a breadth first search ordering, If not provided, we default t the root node of the neuron. By default None
